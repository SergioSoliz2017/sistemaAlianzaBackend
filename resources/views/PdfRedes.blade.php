...
<head>
    <meta charset="UTF-8">
    <title>Informe {{ $redes->NOMBREREDES }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>INFORME</h1>
        <div class="info">
            <p><strong>Nombre:</strong> {{ $redes->NOMBREREDES }}</p>
            <p><strong>Código:</strong> {{ $redes->CODREDES }}</p>
            <p><strong>Cargo:</strong> Redes</p>
            <p><strong>Celular:</strong> {{ $redes->CELULARREDES }}</p>
